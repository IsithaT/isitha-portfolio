        ...
        <div className="w-[65%] h-[60%] min-h-fit flex flex-col gap-13 justify-between">
          <div className="flex h-full w-full justify-between">
            ...
            <div className="min-w-fit min-h-fit gap-3 flex flex-col justify-between items-end p-5">
              ...
              <button
                className="w-full relative px-8 py-2 rounded-md isolation-auto z-10 border-2 border-red-700 
                ...
                border border-gray-200 rounded-lg shadow-sm gap-x-2 disabled:opacity-50 
                disabled:pointer-events-none transition-colors duration-700"
              >
                Resume
              </button>
            </div>
